...
const ChevroletCars = () => {
  ...
  const navigateToChevroletCar = (
    ...
    navigation.navigate("ChevroletCars/[id]", {
      id,
      modal,
      name,
      description,
  ...
  const filteredCars = cars.filter(
    (car) =>
      car.modal.toLowerCase() === "chevrolet" &&
