import {
  ...
  const DoctorMeetingsPage = () => {
    ...
    const handleCancelAppointment = (doctorId, patientId, appointmentId) => {
    ...
    const handleRemoveAppointment = async (doctorId, patientId, appointmentId) => {
    ...
    return (
      ...
      >
        <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
          ...
          />
          <Text style={{ fontWeight: "bold", fontSize: 18 }}>My appointment</Text>
        </View>
            ...
            <View style={{ flexDirection: "row", gap: 10 }}>
              {types.map((type) => (
                ...
                >
                  <Text
                    style={{
                      color: selectedType === type.value ? "#ffffff" : "#246BFD",
                      backgroundColor:
              ...
              >
                ...
                >
                  <Image
                    ...
                    source={{ uri: appointment.patientProfilePicture }}
                  />
                  <View style={{ gap: 10 }}>
                    ...
                    >
                      <Text>
                        {appointment.selectedPackage
                          ? appointment.selectedPackage.charAt(0).toUpperCase() +
                    ...
                    onPress={() =>
                      navigation.navigate(
                        ...
                        }`,
                        {
                          ...
                          doctorProfilePicture: appointment.doctorProfilePicture,
